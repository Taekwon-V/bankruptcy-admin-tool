...
def generate_full_sample_database():
    base_dirs = [
        os.path.abspath("사건저장소"),
        os.path.abspath("사건저장소_샘플")
    ]
    ...
    # 2. Rich datasets for generating 2026 June, July, August (25 cases per month = 75 new cases)
    ...
    for base in base_dirs:
        for month_folder, assign_prefix, meet_prefix, start_idx, end_idx, status_dist in months_plan:
            target_month_dir = os.path.join(base, "2026년", month_folder)
            ...
            for idx, name in enumerate(names):
                ...
                # Some D-3, D-6, D-10, D-14, D-25, D-45
    ...
    print("[OK] Successfully updated all past cases to CLOSED & created 75 realistic cases in 2026 06, 07, 08!")
